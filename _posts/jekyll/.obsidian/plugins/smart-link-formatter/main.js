  ...
  fetchMetadata(url) {
    return __async(this, null, function* () {
      try {
        ...
        console.error(`Failed to fetch YouTube Music metadata for ${url}:`, error);
        new import_obsidian3.Notice("Failed to fetch YouTube Music data.", 3e3);
      }
      return {
        title: escapeMarkdownChars(url),
        artist: void 0,
  ...
  fetchMetadata(url) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        new import_obsidian3.Notice("Failed to fetch Twitter data.", 3e3);
      }
      return {
  ...
  fetchMetadata(url) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        new import_obsidian3.Notice("Failed to fetch Reddit data.", 3e3);
      }
      return {
        title: escapeMarkdownChars(url),
        subreddit: void 0,
  ...
  fetchMetadata(url) {
    return __async(this, null, function* () {
      try {
        ...
        new import_obsidian3.Notice("Failed to fetch GitHub data.", 3e3);
      }
